...
<div x-data="{ openDrawer: false, openDropdown: false, openLogoutModal: false }" class="bg-[#1a63fb] text-white shadow-md relative">
    ...
    @if (!config('services.is_for_department'))
        <div class="bg-orange-500 text-white text-center text-sm py-1 px-4">
            <p>
                অর্ডার আপডেট করতে, ডিলিট করতে বা অন্য যেকোনো সমস্যায় কল দিন অথবা হোয়াটসঅ্যাপ করুন: <br> <a href="tel:+8801234567890" class="underline font-bold text-lg">+8801677-520339</a>
            </p>        
        </div>
    @endif
