    ...
    <div data-key="{{ ! config('services.is_for_department') }}" class="bg-red-800 text-white py-1">
        ...
        @else
            <div class="container mx-auto text-center text-sm">
                This website is developed by <a href="https://github.com/zulfikar2022" target="_blank" class="underline">Sayed Zulfikar Mahmud and </a> | Whatsapp: <a href="https://wa.me/8801309417042" target="_blank" class="underline">+8801309417042</a>
            </div>
        @endif
    </div>
</footer>