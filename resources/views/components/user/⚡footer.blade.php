    ...
    <div data-key="{{ ! config('services.is_for_department') }}" class="bg-slate-800 text-white py-1">
        ...
        @else
            <div class="container mx-auto text-center text-sm">
                This website is developed by <a href="https://github.com/zulfikar2022" target="_blank" class="underline">Sayed Zulfikar Mahmud and </a> and  <a href="https://github.com/ADIBA-ANJUM-HSTU" target="_blank" class="underline">Adiba Anjum</a>
            </div>
        @endif
    </div>
</footer>