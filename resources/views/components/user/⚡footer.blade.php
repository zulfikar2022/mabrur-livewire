 ...
 <footer class="mt-6 w-full bg-[#1a63fb] text-white">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center justify-between container mx-auto px-4 md:px-8 py-6 bg-[#1a63fb] ">
        <div class="text-sm text-center md:text-left flex flex-col items-center md:items-start">
            <a href="{{ route('home') }}"><img class="h-20 w-auto"  src="https://res.cloudinary.com/dq7jdy5xy/image/upload/v1781580244/cropped-mabrur-logo_te6nhl.png" alt="Logo"></a>
        ...
        <div class="flex flex-col gap-5 md:gap-15 items-center md:items-start">
            <div class="flex justify-center space-x-4 text-white">
                ...
                <img src="https://res.cloudinary.com/dq7jdy5xy/image/upload/v1781579501/facebook_logo_qknef0.png" alt="Facebook Icon" class="h-10 w-10 rounded-2xl">
                </a>
                <a href="https://wa.me/8801677520339" target="_blank" class=" ">
                    <img src="https://res.cloudinary.com/dq7jdy5xy/image/upload/v1781580555/whatsapp-logo_e9ncdm.avif" alt="Whatsapp Icon" class="h-10 w-10 rounded-2xl">
                </a>
            </div>
            <div class="">
