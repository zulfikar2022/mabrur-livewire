    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-8">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="ml-auto">
                        <span class="bg-amber-100 text-amber-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                            {{ $userOrders->count() }} Delivery Failed {{ Str::plural('Order', $userOrders->count()) }}
                        </span>
                    </div>
                </div>
        ...
        @empty
            <div class="text-center py-16 text-gray-500">
                ...
                <p class="text-sm mt-1 text-gray-400">There are no delivery failed orders requiring your attention right now.</p>
            </div>
        @endforelse
