        ...
        <div class="space-y-6">
            ...
            <div class="faq-item border-b border-gray-100 pb-6">
                ...
                <p class="text-gray-600 leading-relaxed">
                  আপনাকে আগে লগইন করতে হবে। আপনি যে পণ্যটি কিনতে চান তা নির্বাচন করে 'Order Now' বা 'Add to Cart' বাটনে ক্লিক করুন। এরপর আপনার সঠিক ডেলিভারি ঠিকানা এবং মোবাইল নম্বর প্রদান করে অর্ডারটি সম্পন্ন করুন। আমরা আপনাকে কল দিয়ে অর্ডার নিশ্চিত করব এবং পণ্যটি আপনার ঠিকানায় পৌঁছে দেব।
                </p>
            </div>
            <div class="faq-item border-b border-gray-100 pb-6">
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "আপনাকে আগে লগইন করতে হবে। আপনি যে পণ্যটি কিনতে চান তা নির্বাচন করে 'Order Now' বা 'Add to Cart' বাটনে ক্লিক করুন। এরপর আপনার সঠিক ডেলিভারি ঠিকানা এবং মোবাইল নম্বর প্রদান করে অর্ডারটি সম্পন্ন করুন। আমরা আপনাকে কল দিয়ে অর্ডার নিশ্চিত করব এবং পণ্যটি আপনার ঠিকানায় পৌঁছে দেব।"
      }
    },
    {
      "@type": "Question",
